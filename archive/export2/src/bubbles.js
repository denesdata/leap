...
function bubbleChart() {
        ...
        lessonsTable.append('div')
            ...
            .html(function(d) {
                return '<table>' +
                    ...
                    ((d.Type == 'Policy recommendations') ? '<tr><td><b>Lesson</b></td><td><u>' + d['Policy recommendation'] + '</u></td></tr>' : '') +
                    ((d.Type == 'Policy recommendations') ? '<tr><td><b>Primary</b></td><td>' + d.Primary + '</td></tr>' : '') +
                    ((d.Type == 'Policy recommendations') ? '<tr><td><b>Systemic Gap</b></td><td>' + d['Systemic gap'] + '</td></tr>' : '') +
                    ((d.Type == 'Policy recommendations') ? '<tr><td><b>Proposed action</b></td><td><i>' + d.Quote + '</i></td></tr>' : '') +
                    ((d.Type == 'Qualitative research') ? '<tr><td><b>Lesson</b></td><td><u>' + d.Sentence + '</u></td></tr>' : '') +
                    ((d.Type == 'Qualitative research') ? '<tr><td><b>Quote</b></td><td><i><b>' + d.Quote + '</b></i></td></tr>' : '') +
                    ((d.Type == 'Quantitative research') ? '<tr><td><b>Lesson</b></td><td><u>' + d.Quote + '</u></td></tr>' : '') +
                    ((d.Type == 'Quantitative research') ? '<tr><td><b>Data</b></td><td><img src="src/8.png" style="width:180px;"></td></tr>' : '') +
                    '</table>'
            })
    }
    ...
    function filterTable() {
        ...
        d3.selectAll('.tableEntry')
            .style('display', function(stakeholder) {
                var display = 'none'
